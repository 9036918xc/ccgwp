...
jQuery(document).ready(function () {
	...
	var tg_ajax_button_init = function( tg_ajax_button, tg_ajax_button_category, tg_ajax_button_random, tg_ajax_button_number, tg_ajax_button_child_category, tg_append_ajax_datas, tg_ajax_loading_icon ) {
	...
	jQuery(tg_ajax_button_wrapper).each(function() {
		...
		tg_ajax_button_init( tg_ajax_button, tg_ajax_button_category, tg_ajax_button_random, tg_ajax_button_number, tg_ajax_button_child_category, tg_append_ajax_datas, tg_ajax_loading_icon );
	});
