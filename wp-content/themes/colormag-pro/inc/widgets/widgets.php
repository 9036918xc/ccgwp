...
class colormag_cta_widget extends WP_Widget {
	...
	function __construct() {
		...
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: Call To Action', 'colormag' ), $widget_ops );
	}
...
class colormag_weather_widget extends WP_Widget {
	...
	function __construct() {
		...
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: Weather', 'colormag' ), $widget_ops );
	}
...
class colormag_exchange_widget extends WP_Widget {
	...
	function __construct() {
		...
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: Currency Exchange', 'colormag' ), $widget_ops );
	}
...
class colormag_video_playlist extends WP_Widget {
	...
	function __construct() {
		...
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: Featured Videos Playlist', 'colormag' ), $widget_ops );
	}
...
class colormag_google_maps_widget extends WP_Widget {
	...
	function __construct() {
		...
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = esc_html__( 'TG: Google Maps', 'colormag' ), $widget_ops );
	}
