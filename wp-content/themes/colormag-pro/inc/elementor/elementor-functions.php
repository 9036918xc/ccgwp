...
/**
 * Return the authors of the posts present in the site
 * if they have created any posts for the site.
 *
...
function colormag_elementor_authors() {
	...
	foreach ( $authors as $author ) {
		// Check for if the user have authored any posts
		// or not for the site.
		$post_count = count_user_posts( $author->ID, 'post' );

		// If users have created posts then assign those to
...
if ( ! function_exists( 'colormag_elementor_custom_css' ) ) :
	...
	function colormag_elementor_custom_css() {
		...
		if ( $primary_color != '#289dcc' ) {
			$colormag_internal_elementor_css .= '.elementor .tg-module-wrapper .module-title span,.elementor .tg-module-wrapper .tg-post-category,.elementor .tg-module-wrapper.tg-module-block.tg-module-block--style-5 .tg_module_block .read-more{background-color:' . $primary_color . '}.elementor .tg-module-wrapper .tg-module-meta .tg-module-comments a:hover,.elementor .tg-module-wrapper .tg-module-meta .tg-post-auther-name a:hover,.elementor .tg-module-wrapper .tg-module-meta .tg-post-date a:hover,.elementor .tg-module-wrapper .tg-module-title:hover a,.elementor .tg-module-wrapper.tg-module-block.tg-module-block--style-7 .tg_module_block--white .tg-module-comments a:hover,.elementor .tg-module-wrapper.tg-module-block.tg-module-block--style-7 .tg_module_block--white .tg-post-auther-name a:hover,.elementor .tg-module-wrapper.tg-module-block.tg-module-block--style-7 .tg_module_block--white .tg-post-date a:hover,.elementor .tg-module-wrapper.tg-module-grid .tg_module_grid .tg-module-info .tg-module-meta a:hover,.elementor .tg-module-wrapper.tg-module-block.tg-module-block--style-7 .tg_module_block--white .tg-module-title a:hover{color:' . $primary_color . '}.elementor .tg-module-wrapper .module-title{border-bottom:1px solid ' . $primary_color . '}';
		}
