...
class ColorMag_Elementor_Widgets_Grid_6 extends Widget_Base {
	...
	/**
	 * Register ColorMag_Elementor_Widgets_Grid_6 widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_6_title_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_6_design_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_6_posts_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_6_filter_manage',
			array(
		...
		// Pagination section
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_6_pagination_manage',
			array(
		...
		<div class="tg-module-grid tg-module-grid--style-6 tg-module-wrapper tg-fade-in">
			...
			<div class="tg-row thinner">
				...
				while ( $get_featured_posts->have_posts() ) :
					...
					<?php
					$thumbnail_image_size = ( $count == 1 ) ? 'colormag-elementor-grid-large-thumbnail' : 'colormag-elementor-grid-medium-large-thumbnail';

					if ( ( $count == 1 ) || ( $count == 2 ) ) :
						echo '<div class="tg-col-control">';
					endif;

					$main_div_loop_wrapper_class = ( $count == 1 ) ? 'tg_module_grid tg_module_grid--full' : 'tg_module_grid tg_module_grid--full tg_module_grid tg_module_grid--medium';
					?>
