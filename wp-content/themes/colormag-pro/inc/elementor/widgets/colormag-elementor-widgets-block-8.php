...
class ColorMag_Elementor_Widgets_Block_8 extends Widget_Base {
	...
	/**
	 * Register ColorMag_Elementor_Widgets_Block_8 widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_8_title_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_8_design_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_8_posts_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_8_filter_manage',
			array(
		...
		// Pagination section
		$this->start_controls_section(
			'section_colormag_featured_posts_block_8_pagination_manage',
			array(
