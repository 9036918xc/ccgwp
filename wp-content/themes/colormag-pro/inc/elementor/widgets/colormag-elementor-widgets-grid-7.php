...
class ColorMag_Elementor_Widgets_Grid_7 extends Widget_Base {
	...
	/**
	 * Register ColorMag_Elementor_Widgets_Grid_7 widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_7_title_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_7_design_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_7_posts_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_7_filter_manage',
			array(
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					...
					while ( $get_featured_posts->have_posts() ) :
						...
						<div class="tg_module_grid swiper-slide <?php echo $reading_time_class; ?>" <?php echo $reading_time; ?>>
							<?php
							if ( has_post_thumbnail() ) : ?>
								<figure class="tg-module-thumb">
									<a href="<?php the_permalink(); ?>" class="tg-thumb-link">
										<?php the_post_thumbnail( 'colormag-elementor-block-extra-large-thumbnail' ); ?>
									</a>
								</figure>
							<?php endif;
							?>
