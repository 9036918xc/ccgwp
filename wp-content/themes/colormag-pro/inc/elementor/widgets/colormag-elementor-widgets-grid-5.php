...
class ColorMag_Elementor_Widgets_Grid_5 extends Widget_Base {
	...
	protected function _register_controls() {
		...
		// Pagination section
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_5_pagination_manage',
			array(
			...
			<div class="tg-row thinner">
				...
				while ( $get_featured_posts->have_posts() ) :
					...
					<div class="tg-col-control">
						<div class="tg_module_grid tg_module_grid--small-medium <?php echo $reading_time_class; ?>" <?php echo $reading_time; ?>>
							<?php
