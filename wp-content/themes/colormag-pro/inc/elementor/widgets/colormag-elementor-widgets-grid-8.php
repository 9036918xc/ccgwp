...
class ColorMag_Elementor_Widgets_Grid_8 extends Widget_Base {
	...
	/**
	 * Register ColorMag_Elementor_Widgets_Grid_8 widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_8_title_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_8_design_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_8_posts_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_8_filter_manage',
			array(
		...
		// Pagination section
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_8_pagination_manage',
			array(
		...
		<div class="tg-module-grid tg-module-grid--style-8 tg-module-wrapper tg-fade-in">
			...
			<div class="tg-row thinner">
				...
				while ( $get_featured_posts->have_posts() ) :
					...
					<?php
					$thumbnail_size     = ( $count == 1 ) ? 'colormag-elementor-block-extra-large-thumbnail' : 'colormag-highlighted-post';
					$main_wrapper_class = ( $count == 1 ) ? 'tg_module_grid tg_module_grid--full tg-col-control' : 'tg_module_grid tg_module_grid--small tg_module_grid--one-fourth tg-col-control';
					?>
					...
					echo ' ' . $reading_time_class; ?>" <?php echo $reading_time; ?>>
						...
						<div class="tg-module-info">
							...
							<?php
							if ( $count == 1 ) {
								colormag_elementor_widgets_meta(); // Displays the entry meta
							}
							?>
						</div>
					</div>
