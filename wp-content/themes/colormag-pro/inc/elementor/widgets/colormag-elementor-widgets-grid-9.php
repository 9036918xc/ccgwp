...
class ColorMag_Elementor_Widgets_Grid_9 extends Widget_Base {
	...
	/**
	 * Register ColorMag_Elementor_Widgets_Grid_9 widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_9_title_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_9_design_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_9_posts_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_9_filter_manage',
			array(
		...
		// Pagination section
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_9_pagination_manage',
			array(
