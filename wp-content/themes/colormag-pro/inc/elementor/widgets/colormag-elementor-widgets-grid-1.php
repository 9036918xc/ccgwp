...
class ColorMag_Elementor_Widgets_Grid_1 extends Widget_Base {
	...
	/**
	 * Register ColorMag_Elementor_Widgets_Grid_1 widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_1_title_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_1_design_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_1_posts_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_1_filter_manage',
			array(
		...
		// Pagination section
		$this->start_controls_section(
			'section_colormag_featured_posts_grid_1_pagination_manage',
			array(
		...
		<div class="tg-module-grid tg-module-grid--style-1 tg-module-wrapper tg-fade-in">
			...
			<div class="tg-row thinner">
				...
				while ( $get_featured_posts->have_posts() ) :
					...
					<?php
					$thumbnail_image_size = ( $count == 1 ) ? 'colormag-elementor-grid-large-thumbnail' : 'colormag-highlighted-post';
					...
					$main_div_loop_wrapper_class = ( $count == 1 ) ? 'tg_module_grid tg_module_grid--full' : 'tg_module_grid tg_module_grid--half tg_module_grid--small tg-col-control';
