...
class ColorMag_Elementor_Widgets_Block_7 extends Widget_Base {
	...
	/**
	 * Register ColorMag_Elementor_Widgets_Block_7 widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_7_title_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_7_design_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_7_posts_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_7_filter_manage',
			array(
		...
		// Pagination section
		$this->start_controls_section(
			'section_colormag_featured_posts_block_7_pagination_manage',
			array(
	...
	protected function render() {
		...
		<div class="tg-module-block tg-module-block--style-7 tg-module-wrapper tg-fade-in">
			...
			while ( $get_featured_posts->have_posts() ) :
				...
				if ( $count == 1 ) :
					echo '<div class="tg_module_block tg_module_block--inner-shadow tg_module_block--white ' . $reading_time_class . '" ' . $reading_time . '>';
				elseif ( $count >= 2 ) : // add grid style after first post.
					echo '<div class="tg_module_block tg_module_block--list-small ' . $reading_time_class . '" ' . $reading_time . '>';
				endif;
				?>
