...
class ColorMag_Elementor_Widgets_Block_9 extends Widget_Base {
	...
	protected function _register_controls() {
		...
		// Pagination section
		$this->start_controls_section(
			'section_colormag_featured_posts_block_9_pagination_manage',
			array(
		...
		<div class="tg-module-block tg-module-block--style-9 no-module-thub tg-module-wrapper tg-fade-in">
			...
			<div class="tg-row">
				...
				while ( $get_featured_posts->have_posts() ) :
					...
					?>
					<div class="tg_module_block tg_module_block--list-small no-thumbnail tg-col-control <?php echo $reading_time_class; ?>" <?php echo $reading_time; ?>>
