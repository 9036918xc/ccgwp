...
class ColorMag_Elementor_Widgets_Block_5 extends Widget_Base {
	...
	/**
	 * Register ColorMag_Elementor_Widgets_Block_5 widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_5_title_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_5_design_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_5_posts_manage',
			array(
		...
		$this->start_controls_section(
			'section_colormag_featured_posts_block_5_filter_manage',
			array(
		...
		// Pagination section
		$this->start_controls_section(
			'section_colormag_featured_posts_block_5_pagination_manage',
			array(
			...
			while ( $get_featured_posts->have_posts() ) :
				...
				<div class="tg_module_block <?php echo $reading_time_class; ?>" <?php echo $reading_time; ?>>
					...
					if ( has_post_thumbnail() ) : ?>
						<figure class="tg-module-thumb">
							<a href="<?php the_permalink(); ?>" class="tg-thumb-link">
								<?php the_post_thumbnail( 'colormage-featured-image-large' ); ?>
							</a>
					...
					<div class="block-content">
						...
						<a href="<?php the_permalink(); ?>" class="read-more"><?php echo get_theme_mod( 'colormag_read_more_text', esc_html__( 'Read more', 'colormag' ) ); ?></a>
					</div>
				</div>
